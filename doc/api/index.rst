...
.. The goal of this page is to provide an alphabetical listing of all pyxu_nufft objects exposed to users.
...
Welcome to the official API reference for pyxu_nufft.
...
.. autosummary::
   ...
   ~pyxu_nufft.operator.NUFFT1
   ~pyxu_nufft.operator.NUFFT2
   ~pyxu_nufft.operator.NUFFT3
