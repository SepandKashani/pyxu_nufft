...
from pyxu.operator import FFT, HomothetyOp
...
class FFS(pxa.NormalOp):
    ...
    Reason: FFS() is designed to be used with NUFFT[123](), where linear ordering makes more sense.
    """
    ...
    def apply(self, arr: pxt.NDArray) -> pxt.NDArray:
        ...
        arr: NDArray
            ...
            locations specified by :py:meth:`~pyxu_nufft.operator.FFS.sample_points`, viewed as a real array. (See
        ...
        See Also
        --------
        :py:meth:`~pyxu_nufft.operator.FFS.sample_points`
        """
    ...
    def capply(self, arr: pxt.NDArray) -> pxt.NDArray:
        ...
        arr: NDArray
            ...
            locations specified by :py:meth:`~pyxu_nufft.operator.FFS.sample_points`.
    ...
    def cpinv(self, arr: pxt.NDArray, damp: pxt.Real, **kwargs) -> pxt.NDArray:
        ...
        ----------
        arr: NDArray
            (..., Ns1,...,NsD) FS coefficients :math:`\{\phi_{\mathbf{k}}^{FS}\}_{k=-\mathbf{N}}^{\mathbf{N}} \in
            \mathbb{C}` in increasing order. Trailing entries are 0.
