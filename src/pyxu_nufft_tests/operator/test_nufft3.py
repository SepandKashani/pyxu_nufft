...
class TestNUFFT3(conftest.LinOpT):
    ...
    def _metric(
        ...
        #
        # We choose a conservative threshold, irrespective of the `spp` parameter chosen by the
        # user.
        eps_default = 1e-3
    ...
    @pytest.fixture(
        params=itertools.product(
            [
                ...
                # pxd.NDArrayInfo.DASK,  # not currently supported
            ],
            pxrt.CWidth,
        )
    )
